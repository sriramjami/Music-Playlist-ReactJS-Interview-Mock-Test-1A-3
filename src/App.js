...
class App extends Component {
  ...
  render() {
    ...
    const filterWithSearchList = trackList.filter(eachItem =>
    ...
    return (
      <div className="bg-container">
        ...
        <div className="songs-container">
          ...
          {filterWithSearchList.length > 0 ? (
            <ul className="item-list">
              {filterWithSearchList.map(eachItem => (
                <SongCard
            ...
            <div className="no-song-list">
              <p className="no-list-name">No Songs Found</p>
            </div>
          )}
        </div>
      </div>
